...
% Explain figure
\Fig{fig:04_docker_architecture_architecture} illustrates the client server architecture of Docker which consists of of a Docker client, the Docker deamon and a registry.
