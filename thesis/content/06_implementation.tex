...
% The table
\Tab{table:06_auto-scaler_config_parameter} lists all available configuration parameter. It describes the value type and the default value, if a the parameter is not required, of each parameter.
...
\subsection{Calculating Scaling Heat}
