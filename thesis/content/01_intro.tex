...
%
% GPU is a massive parallel computing device with high computational power and memory bandwidth, which are suitable for data-parallel applications
% Data analytics applications running on Spark usually have rich data parallelism, which naturally matches GPU’s parallel architecture
% GPU’s performance advantage comes from its high parallelism and high memory bandwidth.
% VON Spark-GPU
%
...
\todo{Eher automated software deployment nennen, dann warum das nötig ist und dann auf die pipeline eingehen.}
% Whats the problem
