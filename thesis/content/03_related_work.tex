...
\paragraph{}
Lorido-Botrán et al. \cite{Lorido2014Review} reviewed state-of-the-art literature about auto-scaling and explain proposals of an auto-scaling process in a cloud environment.
% SLA and costs
...
Proactive \textit{Auto-Scalers} use techniques to respond to the current status of the environment (e.g. threshold-based rules).
