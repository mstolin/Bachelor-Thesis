...
\end{enumerate}
% MAPE
To prevent the mentioned problems from occurring, the authors introduced and explained the MAPE architecture (cf. \Sec{sec:02_ac}).
% MAPE phases
...
% This thesis
In this thesis, the focus for scaling strategies is based on the horizontal scaling approach. Therefore, the KHPA algorithm will be used throughout this thesis and is explained in detail in \Sec{sec:04_background_khpa}.
