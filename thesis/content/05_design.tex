...
% resources
The managed resources (introduced in \Sec{subsec:02_ac_resources}) in this environment are the Apache Spark cluster and the GPUs.
% manager
...
% MAPE
The autonomic manager is implemented according to the MAPE architecture, as described in \Sec{subsec:02_ac_manager}. To create a complete control-loop, the autonomic manager comprises multiple components, as illustrated in \Fig{fig:05_am_concept}.
